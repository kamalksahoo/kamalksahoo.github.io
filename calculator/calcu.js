...
var buttondel=document.getElementById("butdel");
...
{   
    ...
    if(z=="DEL")
    {
        var temp=document.getElementById("h2").innerText;
        var n=temp.length;
        var c=temp.slice(0,n-1);
        document.getElementById("h2").innerText=c;
    }
}
...
buttondel.addEventListener("click",function(){display("DEL")});
